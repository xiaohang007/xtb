...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     ./
      ...
      subroutine gfnffdrab2(n,at,cn,nsrb,srblist,rab,ra0,rb0)
      implicit none
      integer n                 ! number of atoms
      integer at(n)             ! ordinal numbers
      real*8  cn(n)             ! D3 CN
      ...
      integer srblist(2,nsrb)   ! list of atom pairs
      real*8 rab(nsrb)          ! output bond lengths estimates, input the predetermined bond shifts
      real*8 ra0(nsrb)          ! output bond lengths estimates, input the predetermined bond shifts
      real*8 rb0(nsrb)          ! output bond lengths estimates, input the predetermined bond shifts
